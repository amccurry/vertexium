...
public class DefaultGraphQuery extends GraphQueryBase {
    ...
    public Iterable<Vertex> vertices(EnumSet<FetchHint> fetchHints) {
        ...
        return SortedIterable.wrapIfNeeded(
                new DefaultGraphQueryIterable<>(getParameters(), this.<Vertex>getIterableFromElementType(ElementType.VERTEX, fetchHints), true, true),
    ...
    public Iterable<Edge> edges(EnumSet<FetchHint> fetchHints) {
        ...
        return SortedIterable.wrapIfNeeded(
                new DefaultGraphQueryIterable<>(getParameters(), this.<Edge>getIterableFromElementType(ElementType.EDGE, fetchHints), true, true),
                getParameters().getSortParameters()
        );
    }
